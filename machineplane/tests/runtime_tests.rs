...
use machineplane::runtimes::{
    create_default_registry, DeploymentConfig, PodStatus, RuntimeEngine,
};
...
async fn deployment_config_defaults() {
    ...
    assert!(config.runtime_options.is_empty(), "Default runtime_options should be empty");
